...
create table customer_info (
    customer_info_id     serial primary key not null,
...
create table etl_customer_tot (
    etl_file_id        serial primary key references etl_file,
    line_number         integer not null,
...
create table product_pkg (
    product_pkg_id      serial primary key,
...
create table product_nomen (
    product_nomen_id   serial  primary key,
...
create table product_suspect_hdr (
    product_suspect_hdr_id serial not null primary key,
    descr                  varchar(60)
)
;--
create table product_suspect_dtl (
    product_suspect_dtl_id serial primary key not null,
...
create table validated_address (
    validated_address_id serial primary key,
    addr_1              varchar(30),
    addr_2              varchar(30),
    city                varchar(25),
    state               varchar(2),
...
/*
  create or replace view etl_sale_post_stat as 
  select 
	etl_file.etl_file_id,
	count(etl_file.etl_file_id) etl_sale_count,
	min(invoice_dt)    invoice_dt_min,
