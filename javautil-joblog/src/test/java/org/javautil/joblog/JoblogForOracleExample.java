...
public class JoblogForOracleExample {
	...
	private void limitedFullJoin() throws SQLException {
		long stepId = 	joblog.insertStep(jobToken, "limitedFullJoin", null, getClass().getName());
	...
	private void fullJoin() throws SQLException {
		...
		long stepId = joblog.insertStep(jobToken,"fullJoin", "fullJoin", getClass().getName());
	...
	private void userTablesCount() throws SQLException {
		long stepId = joblog.insertStep(jobToken,"count full", "userTablesCount", getClass().getName());
