...
# $Header: /home/cvs/cvm-book1/sqltrace/prof.pl,v 1.2 2004/02/27 03:13:29 cvm Exp $

# Cary Millsap (cary.millsap@hotsos.com)
# 
# Copyright (c) 1999-2006 by Hotsos Enterprises, Ltd. All rights reserved.
#
# This source code may be modified provided that you must not alter or remove
# any copyright notice. You must not redistribute the original file or any
# modification thereof.


# Create a resource profile for an Oracle extended SQL trace file, using the
# relationships shown on slide 5.39 of the 2004/02/18 PD101 Notebook:
#
...
print "Copyright (c) 1999-2006 by Hotsos Enterprises, Ltd. All rights reserved.\n\n";

my $ora_version = 9;		# use 7, 8, 9, or 10
my %ora_resolution = (
